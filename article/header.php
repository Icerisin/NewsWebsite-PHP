...
<body>
    <header>
        <div class="container">
            <div class="logo">
                <a href="index.php">
                <img src="../admin/assets/image/<?php getLogo('Header') ?>" alt="" width="80px" height="80px">
                </a>
            </div>
            <ul class="menu">
                ...
                <li class="menu-sport"><a href="javascript:viod(0)">ENTERTAINMENT</a>
                    <ul class="sub-menu sport">
                        <li>
                            <a href="enter-news-national.php">National</a>
                        </li>
                        <li>
                            <a href="enter-news-international.php">International</a>
                        </li>
                    </ul>
                </li>
